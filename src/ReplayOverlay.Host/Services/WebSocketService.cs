...
public class WebSocketService : IDisposable
{
    ...
    public Models.StatsData? GetStats()
    {
        return SafeCall<Models.StatsData?>(() =>
        {
            var s = _obs.GetStats();
            return new Models.StatsData
            {
                CpuUsage = s.CpuUsage,
    ...
    public AppState FetchState(
        List<string>? cachedScenes,
        List<string>? cachedAudioNames,
        string? lastScene)
    {
        var state = new AppState { Connected = IsConnected };
